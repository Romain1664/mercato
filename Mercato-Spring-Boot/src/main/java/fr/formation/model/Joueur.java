...
public class Joueur extends Compte {
	...
	public void regarderStat(Integer id)
	{
		...
		{
			System.out.println("Vous n'�tes pas dans la base de donn�e joueur, veuillez vous inscire d'abord.");
			System.out.print(System.lineSeparator());
		}
	}
	...
	public String toString() {
		return nom + " " + prenom + ", "+ age + " ans : " + poste + " (id : "+ id +") [tir=" + tir
				...
				+ ", tacle=" + tacle + ", marquage=" + marquage + "] �quipe : "	+ nom_equipe + ", prix d'achat : " + prix + "�";
	}
